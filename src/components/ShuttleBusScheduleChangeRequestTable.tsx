  ...
  const calculateBusPrice = (newSelectedSchedules: number[]) => {
    try {
      ...
      const newPrice = schedulesToUse
          .filter(bus => newSelectedSchedules.map(Number).includes(Number(bus.id)))
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="p-4">
          <div className="space-y-4">
            ...
            <div className="rounded-md border flex flex-col h-[calc(100vh-300px)]" ref={tableContainerRef}>
              <div className="overflow-y-auto flex-grow">
                <div className="overflow-x-auto">
                  <Table className="w-full whitespace-nowrap relative">
                    <TableHeader className="bg-gray-50 sticky top-0 z-10">
                      <TableRow>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">부서</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">학년</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap sticky left-0 bg-gray-50 z-20">이름</TableHead>
                        <TableHead colSpan={scheduleColumns.length} className="whitespace-nowrap">
                          <div className="text-center">신청 셔틀버스 일정</div>
                        </TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">금액</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">신청 시각</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">입금 현황</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">메모 작성자명</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">메모 작성 시각</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">메모 내용</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">메모 작성일</TableHead>
                        <TableHead rowSpan={2} className="text-center whitespace-nowrap">액션</TableHead>
                      </TableRow>
                      <TableRow>
                    ...
                    <TableBody>
                      {filteredData.length === 0 ? (
                          ...
                          filteredData.map(row => (
                              ...
                              >
                                <TableCell className="group-hover:bg-gray-50 text-center whitespace-nowrap">{row.department}</TableCell>
                                <TableCell className="group-hover:bg-gray-50 text-center whitespace-nowrap">{row.grade}</TableCell>
                                <TableCell className="sticky left-0 bg-white hover:bg-gray-50 transition-colors duration-150 z-20 font-medium text-center whitespace-nowrap">{row.name}</TableCell>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="overflow-x-auto">
                      <Table>
                        <TableHeader>
                          <TableRow>
                            <TableHead className="text-center whitespace-nowrap">선택</TableHead>
                            <TableHead className="text-center whitespace-nowrap">버스 정보</TableHead>
                            <TableHead className="text-center whitespace-nowrap">출발지</TableHead>
                            <TableHead className="text-center whitespace-nowrap">도착지</TableHead>
                            <TableHead className="text-center whitespace-nowrap">출발 시간</TableHead>
                            {/* 필요한 만큼 컬럼 추가 */}
                          </TableRow>
                        </TableHeader>
                        <TableBody>
                          {schedules.map(schedule => (
                              <TableRow key={schedule.id}>
                                ...
                                <TableCell className="text-center">{schedule.name || "-"}</TableCell>
                                <TableCell className="text-center">
                                  {/* 출발지 */}
