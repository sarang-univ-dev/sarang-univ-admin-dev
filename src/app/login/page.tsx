...
export default function LoginPage() {
  ...
  const [error, setError] = useState<string>("로그인에 실패했습니다");
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Redirect to payment page (입금 조회)
      ...
      <div className="w-full max-w-md px-6">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-8 py-10">
            ...
            <div className="mt-4 flex items-center justify-center gap-2 p-3 rounded-lg bg-red-50 text-red-600 text-sm">
